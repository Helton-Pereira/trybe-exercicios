...
class HashMap:
    def __init__(self):
        # self._buckets = [None for i in range(10)] sem Separate Chaining
    ...
    def insert(self, employee):
        ...
        # self._buckets[address] = employee Sem Separate Chaining
    ...
    def get_value(self, id_num):
        address = self.get_address(id_num)
        # return self._buckets[address].name Sem Separate Chaining
