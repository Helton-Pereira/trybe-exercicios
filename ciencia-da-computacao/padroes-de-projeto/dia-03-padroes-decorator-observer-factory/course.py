...
class CalculadoraDecorada:
    ...
    def converterNumero(self, numero):
        ...
        # Neste cenário, em vez de fazermos IF e else... podemos
        # usar o dicionário
...
if __name__ == '__main__':
    ...
    calculadoraEmIngles = CalculadoraEmIngles(calculadora)
    print("eight + five =", calculadoraEmIngles.soma('eight', 'five'))
